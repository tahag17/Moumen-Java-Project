...
public class ForceEmploiCleaner {
    ...
    public static void cleanData(String inputFile, String outputFile) throws IOException {
        ...
        while (elementsIterator.hasNext()) {
            ...
            cleanedJob.put("Description d'entreprise", getSafeText(job,"competences")); // Pas de champ description entreprise
            cleanedJob.put("Description du poste", "");
            cleanedJob.put("Région", ""); // Pas de champ région
            cleanedJob.put("Ville", ""); // Pas de champ ville
            cleanedJob.put("Secteur d'activité", getSafeText(job,"domain")); // Pas de champ secteur d'activité spécifique
